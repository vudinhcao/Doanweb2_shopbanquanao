<div class="breadcrumb">
                                ...
                                while ($row = mysqli_fetch_array($run)) {
                                    if($i <= $num){
                                        echo '<tr>
                                                ...
                                                <td>'.$row['Gmail'].'</td>
                                                <td>
                                                     <button id = "'.$row['idUser'].'"class="xoa_sp" onclick ="xacnhanxoa('.$row['idUser'].')">Xoá</button><br>
                                                </td>
                                            </tr>';
                                    }
                                    $i++;
        ...
        <script>
             function xacnhanxoa(iduser)
            {
                var answer = confirm("Xác nhận xóa user")
                if (answer) {
                    $.ajax({
                        url : 'modules/content/xoauser.php',
                        type : 'get',
                        data: {
                            id: iduser
