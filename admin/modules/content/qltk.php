                ...
                <table id="table-user">
                    ...
                    <tbody>
                                        ...
                                        if($row['MaNV'] != "Admin")
                                        {
                                         echo '<tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button id = "'.$row['MaNV'].'"class="xoa_sp" onclick ="xacnhanxoa('.$row['STT'].')">Xoá</button><br>
                                                </td>
                                            </tr>';   
                                        }                                       
                                    }
                        ...
                        <script>
                            ...
                            function xacnhanxoa(stt)
                            {
                                var answer = confirm("Xác nhận xóa")
                                if (answer) {
                                    $.ajax({
                                        url : 'modules/content/xoanhanvien.php',
                                        type : 'get',
                                        data: {
                                            id: stt
